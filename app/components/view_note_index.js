...
import { fetchNote, updateNote } from '../actions/action_note'
...
class ViewNoteEditContent extends Component {
  ...
  render () {
    return (
      <MyEditor idData={this.props.params.id} updateNoteData={this.props.updateNote} noteData={this.props.currentNote.content} />
      )
  }
...
export default connect(mapStateToProps, { fetchNote, updateNote })(ViewNoteEditContent)
